<template>
  <div v-if="!initialLoading" class="grid grid-cols-1 lg:grid-cols-2" id="usersettings">
    <div class="flex flex-col">
      ...
      <div class="flex justify-between lg:justify-between items-center py-2">
        ...
        <el-switch v-if="myUser !== null" v-model="myUser.allowsEmailNotifications.value" @change="toggleEmailNotifications()"></el-switch>
      </div>
      <div class="flex justify-between lg:justify-between items-center py-2">
