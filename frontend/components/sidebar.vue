<template>
  <div class="absolute px-6 py-3 left-0 top-0 h-full w-fit base-bg-light dark:base-bg-dark">
    <div class="flex items-center justify-start px-3">
      <svg width="30" height="30" viewBox="0 0 97 97" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          :stroke="getFillColor()" stroke-width="4" stroke-linecap="round" />
      </svg>

      <h1 class="px-3 text-center h-fit">youji</h1>
    </div>
...
import { Files, Plus, Tickets } from '@element-plus/icons-vue';
