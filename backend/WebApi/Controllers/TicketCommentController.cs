...
namespace Application.WebApi.Controllers
{
    ...
    /// </summary>
    /// <param name="commentRepo">Instance of <see cref="TicketComment"/></param>
    [Route("api/[controller]")]
    [ApiController]
    public class TicketCommentController(TicketCommentRepository commentRepo) : ControllerBase
    {
        /// <summary>
