...
namespace Application.WebApi.Controllers
{
    ...
    [ApiController]
    public class BuildingController(BuildingRepository buildingRepo) : ControllerBase
    {
        /// <summary>
        /// Gets all buildings.
        /// </summary>
        ...
        [HttpPut]
        public async Task<ActionResult<Building[]>> Put(Building building)
        {
        ...
        [HttpDelete]
        public async Task<ActionResult<Building[]>> Delete(string id)
        {
