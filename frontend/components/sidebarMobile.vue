      ...
      <el-menu
        ...
        <div>
          ...
          <el-menu-item
            index="1"
            @click="
              router.push(localeRoute('/tickets')?.fullPath as string);
              drawer = !drawer;
            ">
            <el-icon>
              <Files />
        ...
        <div>
          ...
          <el-menu-item
            ...
            index="3"
            @click="
              router.push(localeRoute('/settings')?.fullPath as string);
              drawer = !drawer;
            ">
...
<script lang="ts" setup>
  ...
  function getPageIndex() {
    if (routeObject.route.fullPath == localeRoute('/tickets', locale.value)?.fullPath) {
      return '1';
    } else if (routeObject.route.fullPath == localeRoute('/tickets/new', locale.value)?.fullPath) {
      return '2';
    } else if (routeObject.route.fullPath == localeRoute('/settings', locale.value)?.fullPath) {
      return '3';
    } else {
      return '0';
    }
